...
export default function SocialButton() {
  return (
   ...
   onClick={(e) =>{
    e.preventDefault();
    window.location.href='https://www.instagram.com/leuducquy';
 ...
 <button
  onClick={(e) =>{
    e.preventDefault();
    window.location.href='https://faccebook.com/leuducquy';
...
<button
 onClick={(e) =>{
    e.preventDefault();
    window.location.href='https://twitter.com/Ieuducquy';
...
onClick={(e) =>{
    e.preventDefault();
    window.location.href='https://api.whatsapp.com/send?phone=+84966494779';
...
onClick={(e) =>{
    e.preventDefault();
    window.location.href='https://www.youtube.com/watch?v=jUVXZmUscbY';
...
onClick={(e) =>{
    e.preventDefault();
    window.location.href='https://t.me/920350228';
